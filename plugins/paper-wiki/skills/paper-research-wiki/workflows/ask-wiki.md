...
4. Use `_paper_source/raw` as primary source evidence when formal pages need confirmation. Do not treat `_paper_source/**` as formal graph pages.
...
7. Track correction candidates during retrieval. Include broken wikilinks, ambiguous aliases, duplicate concept owners, stale tracking links, forbidden `_paper_source/**` graph links, source/frontmatter mismatch, and relationship direction mistakes.
