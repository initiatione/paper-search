...
This plugin lives at `plugins/PRW`; its user-visible display name is Paper Wiki, and its current machine-facing plugin name remains `prw` for Stage 1 compatibility.

Paper Wiki was formerly called PRW. Its source-preparation sibling is Paper Source, formerly EPI, whose current machine-facing plugin name remains `epi`.
