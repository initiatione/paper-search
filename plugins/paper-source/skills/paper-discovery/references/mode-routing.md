# Paper Source Discovery Mode Routing
...
| Mode | Use when | Paper Source behavior | Human oversight |
| --- | --- | --- | --- |
...
| `systematic-review` | User asks for PRISMA, meta-analysis, or systematic review | Use Paper Source only to build and screen the corpus; require explicit inclusion/exclusion criteria before any final synthesis | High |
...
5. `guided` should converge quickly into a concrete discovery command; do not turn Paper Source into a long research-coaching session.
