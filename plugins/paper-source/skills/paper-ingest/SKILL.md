...
- Formal page writing after `wiki-ingest-brief.json`: switch to Paper Wiki `$paper-research-wiki`; use `paper-source-paper-deposition/workflows/formal-wiki-write.md` only to clean up historical `wiki_deposition_task.json` requests.
