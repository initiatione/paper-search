...
from paper_source.source_artifacts import resolved_mineru_markdown_relative_path, source_first_artifacts
...
def audit_source_bundle(paper_root: Path) -> dict[str, Any]:
    """Inspect the source-first raw bundle that Paper Source must preserve before wiki handoff."""
    ...
    return {
        "schema_version": "paper-source-source-bundle-audit-v1",
