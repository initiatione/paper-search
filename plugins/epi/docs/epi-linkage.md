...
- `_epi/raw/papers/<slug>/`：PDF、metadata、`paper-search-read-preview.txt`、MinerU Markdown/TeX/images/manifest、reader、critic 和论文级 run-state。
...
- `_epi/raw/papers/<slug>/paper-search-read-preview.txt`（可选 non-authoritative retrieval preview）
