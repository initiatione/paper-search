...
def write_role_reader_outputs(
    *,
    ...
    research_notes = [
        ...
        "- Inference: evaluate whether this paper advances robotics, embodied intelligence, control, or implementation practice.",
    ...
    claims.extend(
        [
            claim_record(
                ...
                claim="Evaluate whether this paper advances robotics, embodied intelligence, control, or implementation practice.",
                source="inference",
