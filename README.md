...
- `scripts/build/paper_source/`：插件内部 Python 模块，承载 CLI 路由、source bundle audit、paper gate、wiki handoff、record workflow、graph visibility 和 language gate。`scripts/build/epi/` 仅保留旧 import shim。
