...
def test_orchestrator_wrapper_imports_bundled_runtime_main():
    ...
    module = _load_module(PLUGIN_ROOT / "scripts" / "orchestrator.py", "paper_source_orchestrator_wrapper_test")
...
def test_wiki_init_wrapper_imports_bundled_runtime_main():
    ...
    module = _load_module(PLUGIN_ROOT / "scripts" / "init_paper_wiki.py", "paper_source_wiki_init_wrapper_test")
...
def test_mineru_wrapper_runs_bundled_runtime_script(monkeypatch):
    ...
    module = _load_module(
        ...
        "paper_source_mineru_wrapper_test",
    )
