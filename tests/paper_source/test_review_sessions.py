...
from paper_source.artifacts import review_root, reviews_root
...
def test_review_session_writes_state_and_artifacts(tmp_path):
    ...
    assert state["schema_version"] == "paper-source-review-session-v1"
...
def test_build_fetch_plan_preserves_pdf_and_manual_links():
    ...
    assert plan["schema_version"] == "paper-source-fetch-plan-v1"
