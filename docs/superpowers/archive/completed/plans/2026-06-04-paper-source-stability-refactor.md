# Paper Source Stability Refactor Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Split Paper Source stability gates and oversized workflow scripts into focused modules, then make real-vault wiki deposition safer.
...
**Tech Stack:** Python stdlib, pytest, Codex plugin manifest JSON, Paper Source Markdown skills/docs.
...
**Files:**
- Create: `plugins/paper-source/scripts/build/paper_source/source_bundle_audit.py`
- Modify: `plugins/paper-source/scripts/build/paper_source/paper_gate.py`
- Test: `tests/paper_source/test_source_bundle_audit.py`
- Test: `tests/paper_source/test_paper_gate.py`
...
**Files:**
- Create: `plugins/paper-source/scripts/build/paper_source/wiki_language.py`
- Create: `plugins/paper-source/scripts/build/paper_source/wiki_handoff_contracts.py`
...
- Test: `tests/paper_source/test_wiki_deposition_task.py`
...
**Files:**
- Create: `plugins/paper-source/scripts/build/paper_source/cli_routes.py`
- Modify: `plugins/paper-source/scripts/build/paper_source/cli.py`
- Test: `tests/paper_source/test_cli_parser.py`
...
**Files:**
- Create: `plugins/paper-source/scripts/build/paper_source/wiki_record_workflows.py`
...
**Files:**
- Create: `plugins/paper-source/scripts/build/paper_source/graph_visibility.py`
- Modify: `plugins/paper-source/scripts/build/paper_source/wiki_init.py`
- Test: `tests/paper_source/test_wiki_init.py`
...
**Files:**
- Modify: `plugins/paper-source/scripts/build/paper_source/run_index.py`
- Test: `tests/paper_source/test_run_index_dashboard.py`
...
- Test: `tests/paper_source/test_current_docs.py`
...
- [ ] Add skill rules that future Paper Source changes should create focused modules instead of growing `cli.py`, `stage_wiki.py`, or `orchestrator.py`.
- [ ] Bump plugin version and short description together.
- [ ] Run focused docs tests.
- [ ] Run broader Paper Source pytest with repo-local `--basetemp`.
- [ ] Validate plugin manifest.
- [ ] With approval, run a real `D:\paper-research-wiki` Paper Source full-chain test and iterate on any failures.
